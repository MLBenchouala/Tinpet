...
user_2.save!
user_3 = User.create(name: "Nathan", description: "Ma chienne adore sortir mais j'en ai marre d'y aller tout seul", age: 36, gender: "homme", orientation: "hétéro", email: "testo.exemple@test.com", password: "123456")
user_3.save!
...
user_6.save!
user_7 = User.create(name: "Laura", description: "Je souhaite rencontrer des gens qui partagent ma passion pour les animaux", age: 26, gender: "femme", orientation: "hétéro", email: "testl.exemple@test.com", password: "123456")
user_7.save!
...
pet_2 = Pet.create(name: "Rocky", sexe: "male", race: "Golden retriever", age: 4, description: "Jade dit à tout le monde que je veux faire des rencontres mais en vrai elle est juste dépressive", user: user_2)
